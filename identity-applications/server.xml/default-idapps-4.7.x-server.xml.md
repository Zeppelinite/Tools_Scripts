---
description: Baseline server.xml for Identity Apps 4.7.(3)
---

# Default IDApps 4.7.x server.xml
...
<Server port="8005" shutdown="SHUTDOWN">
  ...
  <GlobalNamingResources>
    ...
    <Resource auth="Container" driverClassName="org.postgresql.Driver" factory="com.netiq.tomcat.jdbc.pool.CustomBasicDataSourceFactory" initialSize="10" maxActive="50" maxIdle="10" maxWait="30000" minIdle="10" name="shared/IDMUADataSource" password="xqowPmNf5Rt08x3Zp/dwSg==:TKeCyv/V7Heu7Ae82fQ+gA==:mRuRSvGg9vAPgJDveVdJhw==" testOnBorrow="true" type="javax.sql.DataSource" url="jdbc:postgresql://edavis2.lab.novell.com:5432/idmuserappdb" username="idmadmin" validationInterval="120000" validationQuery="SELECT 1" />
    <Resource auth="Container" brokerName="LocalActiveMQBroker" brokerURL="tcp://edavis2.lab.novell.com:61716" description="JMS Connection Factory" factory="org.apache.activemq.jndi.JNDIReferenceFactory" name="jms/ConnectionFactory" type="org.apache.activemq.ActiveMQConnectionFactory" />
